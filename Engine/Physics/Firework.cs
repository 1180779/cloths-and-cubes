...
namespace Engine.Physics
{
    ...
    public class FireworkRule
    {
        ...
        public Real minAge;
        public Real maxAge;
        public Engine.Physics.Vector3 minVelocity;
        public Engine.Physics.Vector3 maxVelocity;
        public Real damping;
        ...
        public void Create(Firework firework, Firework? parent)
        {
            ...
            Engine.Physics.Vector3 vel = (parent != null) ? parent.velocity : new Vector3();
            vel += Engine.Physics.Vector3.RandomVector(r, minVelocity, maxVelocity);
