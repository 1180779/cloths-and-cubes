...
public abstract class VisualObjectBase : IVisualObject
{
    ...
    public Matrix4 Model =>  Matrix4.CreateScale(Scale) * Matrix4.CreateFromQuaternion(Rotation) * Matrix4.CreateTranslation(Position);
    //
